...
import 'package:gadwelha/main.dart';
import 'package:gadwelha/pages/home.dart';

class NotificationService {
  static const channelKeys = {
    'eyeSafetyAlert': 'eyeSafetyAlert',
    'backVertebraeSafetyAlerts': 'backVertebraeSafetyAlerts',
  ...
  static Future<void> initializeNotification() async {
    await AwesomeNotifications().initialize(
      ...
      [
        NotificationChannel(
          channelGroupKey: channelKeys['eyeSafetyAlert'],
          channelKey: channelKeys['eyeSafetyAlert'],
          channelName: 'eyeSafetyAlert',
          channelDescription: 'Notification channel for basic tests1',
        ...
        NotificationChannel(
          channelGroupKey: channelKeys['backVertebraeSafetyAlerts'],
          channelKey: channelKeys['backVertebraeSafetyAlerts'],
          channelName: 'backVertebraeSafetyAlerts',
          channelDescription: 'Notification channel for basic tests2',
          defaultColor: const Color(0xFF9D50DD),
          ledColor: Colors.white,
          importance: NotificationImportance.Max,
          channelShowBadge: true,
      ...
      channelGroups: [
        NotificationChannelGroup(
          channelGroupKey: channelKeys['eyeSafetyAlert'].toString(),
          channelGroupName: 'Group 1',
        ),
        NotificationChannelGroup(
          channelGroupKey: channelKeys['backVertebraeSafetyAlerts'].toString(),
